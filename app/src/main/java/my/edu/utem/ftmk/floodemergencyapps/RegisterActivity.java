    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signUpBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final String getPhoneNumberTxt = phoneEt.getText().toString();
                final String getEmailTxt = usernameEt.getText().toString();
...
//                intent.putExtra("Phone Number", getPhoneNumberTxt);
//                intent.putExtra("username", getEmailTxt);
